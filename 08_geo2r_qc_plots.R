#!/usr/bin/env Rscript
# =============================================================================
# Section 08 — GEO2R-like QC plots
# Figures: 05_geo2r_style_boxplot, 06_geo2r_style_density,
#          07_batch_qc_pca_by_condition, 08/09_batch_qc_pca (if batch detected),
#          10_geo2r_style_umap, 11_sample_distance_heatmap,
#          12_deseq2_dispersion_estimates, 13_geo2r_style_mean_variance_trend
# =============================================================================
