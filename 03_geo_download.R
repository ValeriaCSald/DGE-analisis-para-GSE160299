#!/usr/bin/env Rscript
# =============================================================================
# Section 03 — GEO download
# Downloads Series Matrix metadata and supplementary count files for GSE_ID.
# Extracts tar archives if present and identifies the count matrix file.
# =============================================================================
