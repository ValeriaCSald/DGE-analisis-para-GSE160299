#!/usr/bin/env Rscript
# =============================================================================
# Section 05 — Count matrix parsing
# Reads the raw count matrix, identifies sample columns, aligns sample IDs
# to GEO metadata, removes samples with unresolvable condition labels,
# and saves parsed counts + colData to results/.
# =============================================================================
