#!/usr/bin/env Rscript
# =============================================================================
# Section 07 — DESeq2 model construction and normalization
# Builds DESeqDataSet, applies low-count filter, chooses design formula
# (with batch only if non-confounded), runs DESeq(), and saves normalized counts.
# =============================================================================
