#!/usr/bin/env Rscript
# =============================================================================
# Section 09 — Differential expression
# Extracts DESeq2 results, applies lfcShrink, annotates gene symbols,
# writes all-genes and significant-genes tables, and plots:
#   14_deg_counts_summary, 15_geo2r_style_volcano,
#   16_geo2r_style_MD_MA_plot, 17_raw_pvalue_histogram,
#   18_geo2r_style_adjusted_pvalue_histogram, 19_geo2r_style_qq_plot_pvalues
# =============================================================================
