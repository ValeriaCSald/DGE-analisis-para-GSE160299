#!/usr/bin/env Rscript
# =============================================================================
# Section 10 — Heatmaps and gene profiles
# Figures: 20_top_de_genes_heatmap, 21_geo2r_style_gene_profile_top_genes
# Optional (≥2 contrasts): 22_geo2r_style_venn_diagram
# =============================================================================
