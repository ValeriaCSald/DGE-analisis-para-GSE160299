#!/usr/bin/env Rscript
# =============================================================================
# Section 02 — Plot helpers
# Defines publication-grade ggplot theme, save wrappers, palette helpers,
# and a compact label formatter compatible with all scales versions.
# =============================================================================
