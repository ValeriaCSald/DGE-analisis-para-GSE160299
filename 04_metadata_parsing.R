#!/usr/bin/env Rscript
# =============================================================================
# Section 04 — Metadata parsing
# Infers condition labels (NC / PD) and detects potential batch fields
# from GEO sample metadata. Writes parsed metadata CSV to results/.
# =============================================================================
